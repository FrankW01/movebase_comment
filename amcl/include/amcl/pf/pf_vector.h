...
#ifdef __cplusplus//如何是C++代码，就需要加上extern "C"
extern "C" {
#endif
...
{
  double m[3][3];
} pf_matrix_t;//3*3的二维数组


// Return a zero vector
pf_vector_t pf_vector_zero();

// Check for NAN or INF in any component 判断是否有一些nan或者inf的值
...
// Transform from local to global coords (a + b) 从局部坐标转化为全局坐标具体如何实现？？？什么含义呢？
